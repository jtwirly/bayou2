...
// Ideally now or in future, have it make a formatted printable quiz (may requires images in black and white or grey scale) in Google Docs or Google Slides format for this lesson, show it to the user, and save it to the database