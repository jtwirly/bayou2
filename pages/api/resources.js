    ...
    try {
      ...
      if (error) {
        ...
        const completion = await openai.createCompletion({
          ...
          prompt: `Provide resources for this ${lessonPlan}, for a ${gradeLevel} grade ${subject} class following the ${curriculum} curriculum, focusing on the strand of ${strand}, the topic of ${topic} and the expectations of ${expectations}, with a duration of ${duration}, using the ${method} pedagogical method, the ${framework} framework, and the ${mode} learning mode, taking into account considerations for ${considerations} and accommodation for ${accommodations}. Links to subject-specific Blookets or Kahoot would be useful if there are some good ones related to this ${lessonPlan}.`,
          max_tokens: 1024,
          temperature: 0.8,
        });
...
// Ideally now or in future, have it make a formatted printable resources page in Google Docs or Google Slides format for this lesson, show it to the user, and save it to the database